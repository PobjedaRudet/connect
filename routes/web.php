...
// Jednokratno: samo tabela sihterica_audit_logs. Ne pokreće ostale migracije i ne briše podatke.
Route::get('/system/migrate-sihterica-audit/{token}', function (string $token) {
    $expected = 'd450f9d161f668c0f41d99c2a90cbb7ad86a87ea166b32bfad6a3715f513e915';

    if (! hash_equals($expected, $token)) {
        abort(404);
    }

    $migration = '2026_07_15_150000_create_sihterica_audit_logs_table';
    $path = 'database/migrations/'.$migration.'.php';

    if (\Illuminate\Support\Facades\Schema::hasTable('sihterica_audit_logs')) {
        ...
        return response(
            'Tabela sihterica_audit_logs već postoji. Ostale tabele nisu dirane.',
            200,
    ...
    return response(
        "Pokrenuta je samo migracija {$migration}. Ostale tabele nisu dirane.\n\n"
