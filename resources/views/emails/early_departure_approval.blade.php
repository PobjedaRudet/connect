...
<head>
    ...
    <title>Prijevremeni odlazak — odobrenje izlaznice</title>
</head>
<body style="margin:0; padding:0; background-color:#f3f4f6;">
    ...
    <div style="display:none;font-size:1px;color:#f3f4f6;line-height:1px;max-height:0;max-width:0;opacity:0;overflow:hidden;">
        Radnik {{ $fullName ?: 'Nepoznat' }} napustio radno mjesto {{ $earlyMin }} min ranije — potrebno je odabrati tip izlaznice.
    </div>
                ...
                <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0"
                    ...
                    <tr>
                        <td style="background-color:#0369a1; padding:20px 24px;">
                            <div style="font-family:Arial,Helvetica,sans-serif; font-size:14px; color:#bae6fd;">
                                {{ $appName }}
                            </div>
                            ...
                            <div style="font-family:Arial,Helvetica,sans-serif; font-size:13px; color:#7dd3fc;
                                        margin-top:6px;">
                    ...
                    <tr>
                        <td style="padding:20px 24px 8px 24px; font-family:Arial,Helvetica,sans-serif; color:#0f172a;">
                            <div style="font-size:14px; line-height:22px; color:#334155;">
                                Poštovani,<br><br>
                                Radnik <strong>{{ $fullName ?: '—' }}</strong> napustio je radno mjesto
                                prije isteka radnog vremena.
                                Automatski je kreirana izlaznica za period prijevremenog odlaska.
                                Molimo odaberite da li je razlog <strong>privatne</strong> ili
                    ...
                    <tr>
                        <td style="padding:0 24px 8px 24px;">
                            <p style="font-family:Arial,Helvetica,sans-serif; font-size:13px; color:#475569;
                                      margin:0 0 12px 0;">
                                Odaberite tip izlaznice klikom na jedno od dugmadi:
                            </p>
                        </td>
                    </tr>
                    <tr>
