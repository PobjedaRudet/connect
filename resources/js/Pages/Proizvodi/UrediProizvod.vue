<template>
  <ProductionAppLayout title="Uredi proizvod">
    <template #header>
      <div class="flex items-center justify-between">
        <div>
          <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Uredi proizvod</h2>
...
const form = ref({
  Naziv: props.product.Naziv || '',
  SkraceniNaziv: props.product.SkraceniNaziv || '',
  Tip: props.product.Tip || '',
  JedinicaMjere: props.product.JedinicaMjere || '',
  Code: props.product.Code || '',
  UoM_meter: props.product.UoM_meter || '',
  UsporenjeMs: props.product.UsporenjeMs || null,
  UNNumber: props.product.UNNumber || '',
  HazardClass: props.product.HazardClass || '',
  CEMarkNumber: props.product.CEMarkNumber || '',
  NumeraProizvoda: props.product.NumeraProizvoda || null,
  VrstaProvodnika: props.product.VrstaProvodnika || '',
});
...
async function submit() {
  message.value = '';
  try {
    await router.put(`/proizvodi/${props.product.id}`, form.value, { preserveState: true });
...
function reset() {
  form.value = { Naziv: props.product.Naziv || '', SkraceniNaziv: props.product.SkraceniNaziv || '', Tip: props.product.Tip || '', JedinicaMjere: props.product.JedinicaMjere || '', Code: props.product.Code || '', UoM_meter: props.product.UoM_meter || '', UsporenjeMs: props.product.UsporenjeMs || null, UNNumber: props.product.UNNumber || '', HazardClass: props.product.HazardClass || '', CEMarkNumber: props.product.CEMarkNumber || '', NumeraProizvoda: props.product.NumeraProizvoda || null, VrstaProvodnika: props.product.VrstaProvodnika || '' };
}
</script>
