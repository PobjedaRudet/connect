...
const links = [
  { label: 'Izlaznice', href: route('passes.active'), route: 'passes.active' },
  { label: 'Sumarno', href: route('hr.izlaznice.sumarno'), route: 'hr.izlaznice.sumarno' },
  { label: 'Uposlenici', href: route('hr.uposlenici.pregled'), route: 'hr.uposlenici.pregled' },
  ...
  { label: 'Saldo GO', href: route('hr.godisnji.saldo'), route: 'hr.godisnji.saldo' },
  { label: 'Rješenja GO', href: route('hr.godisnji.rjesenja'), route: 'hr.godisnji.rjesenja' },
  { label: 'Iskorišteni GO', href: route('hr.godisnji.iskoristenje'), route: 'hr.godisnji.iskoristenje' },
  { label: 'Bolovanja', href: route('hr.bolovanja'), route: 'hr.bolovanja' },
]
